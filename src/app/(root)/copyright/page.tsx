  ...
  return (
    <div className="min-h-screen bg-black text-white pt-20">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-6">{t('policy.copyright.title')}</h1>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">{t('policy.copyright.statement')}</h2>
          <p className="text-gray-300 leading-relaxed">
            {t('policy.copyright.statementDesc')}
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-neutral-900 p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">{t('policy.copyright.process')}</h3>
            <ol className="list-decimal pl-5 space-y-2 text-gray-300">
              <li>{t('policy.copyright.process1')}</li>
              <li>{t('policy.copyright.process2')}</li>
              <li>{t('policy.copyright.process3')}</li>
              <li>{t('policy.copyright.process4')}</li>
              <li>{t('policy.copyright.process5')}</li>
            </ol>
          </div>
          
          <div className="bg-neutral-900 p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">{t('policy.copyright.requirements')}</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
              {t('policy.copyright.requirementsDesc')}
            </p>
            <ul className="list-disc pl-5 space-y-2 text-gray-300">
              <li>{t('policy.copyright.requirement1')}</li>
              <li>{t('policy.copyright.requirement2')}</li>
              <li>{t('policy.copyright.requirement3')}</li>
              <li>{t('policy.copyright.requirement4')}</li>
              <li>{t('policy.copyright.requirement5')}</li>
              <li>{t('policy.copyright.requirement6')}</li>
            </ul>
          </div>
        </div>
