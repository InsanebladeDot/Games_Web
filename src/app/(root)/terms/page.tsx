  ...
  return (
    <div className="min-h-screen bg-black text-white pt-20">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-6">{t('policy.terms.title')}</h1>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">{t('policy.terms.welcome')}</h2>
          <p className="text-gray-300 leading-relaxed">
            {t('policy.terms.welcomeDesc')}
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-neutral-900 p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">{t('policy.terms.serviceTerms')}</h3>
            <ol className="list-decimal pl-5 space-y-2 text-gray-300">
              <li>{t('policy.terms.serviceTerm1')}</li>
              <li>{t('policy.terms.serviceTerm2')}</li>
              <li>{t('policy.terms.serviceTerm3')}</li>
              <li>{t('policy.terms.serviceTerm4')}</li>
              <li>{t('policy.terms.serviceTerm5')}</li>
              <li>{t('policy.terms.serviceTerm6')}</li>
            </ol>
          </div>
          
          <div className="bg-neutral-900 p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">{t('policy.terms.userContent')}</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
              {t('policy.terms.userContentDesc')}
            </p>
            <ul className="list-disc pl-5 space-y-2 text-gray-300">
              <li>{t('policy.terms.userContentTerm1')}</li>
              <li>{t('policy.terms.userContentTerm2')}</li>
              <li>{t('policy.terms.userContentTerm3')}</li>
              <li>{t('policy.terms.userContentTerm4')}</li>
              <li>{t('policy.terms.userContentTerm5')}</li>
            </ul>
          </div>
        </div>
