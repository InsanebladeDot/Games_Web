      ...
      <div className="flex flex-col md:flex-row justify-between max-w-full">
        ...
        <div className="flex-1 min-w-[320px]">
          ...
          <div className="my-4 flex flex-wrap gap-x-6 gap-y-2 text-sm">
            <a href="#" className="hover:underline" onClick={e => e.preventDefault()}>{t('footer.cookie_policy')}</a>
            <a href="#" className="hover:underline" onClick={e => e.preventDefault()}>{t('footer.copyright')}</a>
            <a href="#" className="hover:underline" onClick={e => e.preventDefault()}>{t('footer.privacy_policy')}</a>
            <a href="#" className="hover:underline" onClick={e => e.preventDefault()}>{t('footer.terms')}</a>
          </div>
        ...
        <div className="flex flex-col items-end justify-between min-w-[320px] pr-0 md:pr-10">
          <div className="flex gap-10 mb-8">
            <a href="/gamelist" className="text-white font-semibold hover:underline" >{t('header.games')}</a>
            <a href="/articles" className="text-white font-semibold hover:underline" >{t('header.articles')}</a>
            <a href="/about" className="text-white font-semibold hover:underline" >{t('header.about')}</a>
          </div>
          <div className="flex gap-4">
            ...
            <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full border border-neutral-500 text-white hover:bg-neutral-800 transition" onClick={e => e.preventDefault()}>
